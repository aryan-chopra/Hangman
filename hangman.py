...
def StartScreen():
    ...
    #Image properties
    ImageToBeDisplayed = ctk.CTkImage(dark_image = Image.open("./image.png"),size=(600,600))
...
def loading():
    ...
    ImageToBeDisplayed = ctk.CTkImage(dark_image = Image.open("./image.png"),size=(700,350))
...
def main_game():
    ...
    RetryButtonImage = ctk.CTkImage(dark_image = Image.open("./reload.png"), size=(35,35))
    ...
    QuitButtonImage = ctk.CTkImage(dark_image = Image.open("./quit.png"), size=(35,35))
